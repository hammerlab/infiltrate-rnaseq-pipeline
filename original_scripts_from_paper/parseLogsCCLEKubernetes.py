...
for dir in sample_dirs:
    ...
    with open(dir + "/time.txt",'r') as time:
        for line in time:
            ...
            if line[0] == "Copying Index:":
                progress.write(id + "\tstart\t" + line[1] + "\n")
            elif line[0] == "Finished Copying .bam":
                progress.write(id + "\tcopying\t" + line[1] + "\n")
            elif line[0] == "Finished data to bucket":
                progress.write(id + "\tcleanup\t" + line[1] + "\n")
